...
public class ScoringIdempotencyService {
    ...
    private static final String IDEMPOTENCY_PREFIX = "aiwriting:idempotency:";
    private static final String CONTENT_PREFIX = "aiwriting:content-submission:";

    private final StringRedisTemplate redisTemplate;
    private final ObjectMapper objectMapper;

    @Value("${aiwriting.idempotency.redis-required:false}")
